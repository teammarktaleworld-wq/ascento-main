...
import { Blob } from "@/ui/home/Blob";
import { Star } from "@/ui/home/Star";
import SummerCampBanner from "@/components/SummerCampBanner"; // 👈 added
  ...
  return (
    ...
    >
      ...
      <div style={{ background: p.color + "18", padding: "40px 24px 24px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div style={{ fontSize: 64, lineHeight: 1, marginBottom: 12 }} className="float-b">
          {p.emoji}
        </div>
      ...
      <div style={{ padding: "20px 24px 28px" }}>
        <h3 style={{ fontFamily: "'Fredoka One',cursive", fontSize: 22, color: "#1A1A2E", marginBottom: 10 }}>
          {p.title}
        </h3>
        <p style={{ fontSize: 14, lineHeight: 1.6, color: "#666", marginBottom: 20 }}>
          {p.desc}
        </p>
        <Link
          href={`/programs#prog-${p.slug}`}
