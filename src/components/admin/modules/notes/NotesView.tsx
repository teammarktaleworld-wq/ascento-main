...
// // ─── Auth helper ──────────────────────────────────────────────────────────────
// // Reads the active Supabase session and returns an Authorization header.
// // Every API call passes this so requireAdmin() on the server can verify the token.
...
//           background: "#FAF7EE",
//         }}>
//           <span style={{ fontWeight: 700, fontSize: 15, color: "#2C2A22", fontFamily: "'Georgia', serif" }}>
//             📄 {title}
//           </span>
...
//     if (!isEdit && !file) return setError("Please upload a PDF.");
//     setSaving(true);
//     setError("");
//     try {
//       if (isEdit) {
//         await API.update(editNote!.id, { title, label, type, serialId }, file);
//       } else {
//         await API.create({ title, label, type, serialId }, file!);
//       }
//       onSaved();
//       onClose();
//     } catch (err: unknown) {
...
//     borderRadius: 8, border: "1.5px solid #DDD8CC",
//     background: "#FFFDF7", color: "#2C2A22",
...
//         <h2 style={{
//           margin: "0 0 24px",
//           fontSize: 20, fontWeight: 800, color: "#2C2A22",
...
//           <div>
//             <label style={labelStyle}>PDF File {isEdit && "(leave blank to keep current)"}</label>
//             <div
//               onClick={() => fileRef.current?.click()}
//               style={{
//                 border: "2px dashed #CCC8BE", borderRadius: 10,
//                 padding: "18px 16px", cursor: "pointer",
//                 background: file ? "#F0FBF3" : "#FAF7EE",
//                 color: file ? "#1A7A3A" : "#888",
...
//         background: "#F5F0E4",
//         display: "flex", alignItems: "center", justifyContent: "center",
//         fontWeight: 800, fontSize: 15, color: "#8B7D5A",
//         flexShrink: 0,
...
//   note, onClose, onConfirm, deleting,
...
//               <div style={{ fontSize: 13, color: "#AAA", maxWidth: 400 }}>
//                 The PDF file may be missing or the storage bucket is not configured correctly.
...
//               PDF File {isEdit && "(leave blank to keep current)"}
//             </label>
//             <div
//               onClick={() => fileRef.current?.click()}
//               style={{
...
//         </h3>
//         <p style={{ color: "#666", fontSize: 14, margin: "0 0 24px" }}>
//           "<strong>{note.title}</strong>" will be permanently deleted along with
//           its PDF.
//         </p>
//         <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
//           <button
...
//   return (
//     <div
//       style={{ fontFamily: "'Segoe UI', sans-serif", maxWidth: 860, margin: "0 auto" }}
//     >
//       {/* Header */}
//       <div
//         style={{
...
//                 borderRadius: 10,
//                 background:
//                   activeTab === tab ? "rgba(255,255,255,0.2)" : "#DDD8CC",
//                 color: activeTab === tab ? "#fff" : "#888",
//                 fontSize: 11,
//                 fontWeight: 800,
//               }}
