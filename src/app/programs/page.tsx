...
//         <div className="prog-hero-deco" style={{ position:"absolute", top:"15%", left:"6%", fontSize:48 }} className="float-a">📚</div>
//         <div className="prog-hero-deco" style={{ position:"absolute", top:"20%", right:"8%", fontSize:40 }} className="float-b">🧠</div>
//         <div className="prog-hero-deco" style={{ position:"absolute", bottom:"15%", left:"10%", fontSize:36 }} className="float-b">🧮</div>
//         <div className="prog-hero-deco" style={{ position:"absolute", bottom:"20%", right:"6%", fontSize:44 }} className="float-a">⭐</div>
...
//                     <div className="prog-card-header-emoji" style={{ fontSize:52, lineHeight:1 }} className="float-b">{p.emoji}</div>
//                     <div>
